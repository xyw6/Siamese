...
def train(X_train, X_val, Y_train, Y_val, embedding, l, n_hidden = 50, grad = 1.25, batch = 64, epoch = 25):
    ...
    model.compile(loss = 'binary_crossentropy', optimizer = Adadelta(clipnorm = grad), metrics = ['acc', TPR, PPV])
