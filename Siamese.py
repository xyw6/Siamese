...
def train(X_train, X_val, Y_train, Y_val, embedding, l, n_hidden = 50, batch = 64, epoch = 25):
    ...
    model.compile(loss = 'binary_crossentropy', optimizer = Adadelta(), metrics = ['acc', TPR, PPV])
